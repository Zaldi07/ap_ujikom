                                  ...
                                  <table class="table table-borderless datatable">
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  ...
                                                  <td><a href="{{ url('jenis/' .$item->id_jenis.'/edit')}}" class="btn btn-success btn-sm" >
                                                    <span class="bi bi-pencil-square" style="font-size:12px"></span></a> </td>
                                                  <td><form action="{{ url('jenis/' .$item->id_jenis)}}" method="post" class="d-inline" onsubmit="return confirm('Yakin Hapus Data')">
                                                    @method('delete')
                                                    @csrf
